...
?>
    ...
    <div class="grid_9 full content contact-page">
        ...
        <div class="contact-page contact-map">
            ...
            <!-- <p><?php echo __( 'Katara Hospitality head office has moved to Lusail City', "Katara" ); ?>. <a target="_blank" href="<?php bloginfo('url'); ?>/wp-content/uploads/2013/09/Katara-Hospitality-Building-Lusail-City.pdf"><?php _e( 'Download directions as a PDF', "Katara" ); ?></a></p> -->
            <div id="map"></div>
        </div>
    </div>    
